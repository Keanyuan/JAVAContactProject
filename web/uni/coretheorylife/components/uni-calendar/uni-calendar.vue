<template>
	<view class="uni-calendar" @touchmove.stop.prevent="clean">
		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			...
			<view class="uni-calendar__header__ncweek ">
				<view v-for="(item,weekIndex) in ncWeeks" :key="weekIndex">
					<text class="uni-calendar__header__ncweek-text">{{item}}</text>
				</view>
			</view>
...
<style lang="scss" scoped>
	...
	.uni-calendar__header__ncweek-text{
		text-align: center;
		font-size: $uni-font-size-base;
		color: $uni-text-color;
		font-weight: bold;

<template>
	<view class="m-input-view">
		<input :focus="focus_" :type="inputType" :value="value" @input="onInput" class="m-input-input" :placeholder="placeholder"
		 :password="type==='password'&&!showPassword" @focus="onFocus" @blur="onBlur" :maxlength="maxlength" :adjust-position="adjustPosition"/>
		<!-- 优先显示密码可见按钮 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			onInput(e) {
				this.$emit('input', e.target.value, this.dateKey)
			}
		}
	}
</script>

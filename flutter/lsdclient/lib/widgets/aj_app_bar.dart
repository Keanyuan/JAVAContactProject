...
const double _kLeadingWidth =
    kToolbarHeight + 60; // So the leading button is square.
...
class AJMyAppBar extends StatefulWidget implements PreferredSizeWidget {
...
class _MyAppBarState extends State<AJMyAppBar> {

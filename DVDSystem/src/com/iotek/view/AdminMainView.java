...
public class AdminMainView extends JFrame {
	...
	private static final long serialVersionUID = -2309005712277502060L;
	...
	public AdminMainView(Users user) {
	...
	private void init(){
		...
		lb_welcome = new JLabel("欢	迎	"+ user.getUname() +"	使	用	影	碟	租	管	理	赁	系	统");
	...
	private void registerListener(){
		btn_query_rent_dvd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				AdminDVDOperatorView adv = new AdminDVDOperatorView();
				//把指定的视图添加到桌面
				funcDesktop.add(adv);
				adv.toFront();
			}
		...
		btn_dvd_record.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				AdminQueryDVDRecordVeiw adminQuery = new AdminQueryDVDRecordVeiw();
				//把指定的视图添加到桌面

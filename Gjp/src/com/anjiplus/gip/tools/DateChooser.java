...
public class DateChooser extends JPanel{
    ...
    private class BodyPanel extends JPanel {
        ...
        public void updateDate() {
            ...
            // 锟接碉拷锟斤拷1锟斤拷前锟狡ｏ拷一直锟狡讹拷锟斤拷锟斤拷锟斤拷锟绞撅拷牡锟揭伙拷锟斤拷前一锟届；锟斤拷-index + defaultStartDAY为锟斤拷锟斤拷时锟斤拷为锟斤拷锟斤拷锟斤拷锟接碉拷锟斤拷1锟斤拷之锟斤拷始锟斤拷示锟斤拷锟斤拷要前锟斤拷一锟杰ｏ拷确锟斤拷锟斤拷锟斤拷锟斤拷示锟斤拷全
    ...
    private class LabelManager {
        ...
        public void setSelect(Point p, boolean b) {
            //锟斤拷锟斤拷锟斤拷隙锟�,锟斤拷要锟脚伙拷一锟斤拷,锟斤拷锟斤拷锟叫э拷锟�  
            if (b) {
                //锟斤拷示锟角凤拷锟杰凤拷锟斤拷,锟斤拷锟矫比斤拷锟斤拷锟斤拷锟叫的憋拷签,锟杰凤拷锟截的憋拷志锟斤拷锟角帮拷锟斤拷一锟斤拷锟斤拷签锟斤拷  
                //锟斤拷要锟斤拷示锟侥憋拷签锟揭碉拷锟剿就匡拷锟斤拷锟斤拷  
...
//        DateChooser ser2 = DateChooser.getInstance("yyyy锟斤拷MM锟斤拷dd锟斤拷");

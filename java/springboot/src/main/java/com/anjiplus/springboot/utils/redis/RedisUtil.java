 ...
 * </p>
 * @author qiu
 * @version : RedisUtil, v <versionName> 16:19 2018/6/9 qiu Exp $
 */
@Configuration
public class RedisUtil<T> {
     ...
     */
    public Long hdel(String key, T... item) {
     ...
     * @return
     */
    public T getIListByIndex(String key, long index) {
        try {
     ...
     * @return
     */
    public boolean setAllList(String key, List<T> value) {
        try {
     ...
     * @return
     */
    public boolean setAllList(String key, List<T> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(key, time);
